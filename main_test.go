...
// Define expected tokens
    ...
    // Line 1
    &query_processor.Token{Token_type: "Keyword", Val: "insert_into"},
    &query_processor.Token{Token_type: "Identifier", Val: "cats"},
    &query_processor.Token{Token_type: "Operator", Val: "("},
    &query_processor.Token{Token_type: "Identifier", Val: "cat_names"},
    &query_processor.Token{Token_type: "Operator", Val: ","},
    &query_processor.Token{Token_type: "Identifier", Val: "age"},
    &query_processor.Token{Token_type: "Operator", Val: ","},
    &query_processor.Token{Token_type: "Identifier", Val: "weight"},
    &query_processor.Token{Token_type: "Operator", Val: ")"},
    // Line 2
    &query_processor.Token{Token_type: "Keyword", Val: "values"},
    &query_processor.Token{Token_type: "Operator", Val: "("},
    &query_processor.Token{Token_type: "Literal", Val: "whiskers"},
    &query_processor.Token{Token_type: "Operator", Val: ","},
    &query_processor.Token{Token_type: "Literal", Val: "3"},
    &query_processor.Token{Token_type: "Operator", Val: ","},
    &query_processor.Token{Token_type: "Literal", Val: "4"},
    &query_processor.Token{Token_type: "Operator", Val: ")"},
    &query_processor.Token{Token_type: "Operator", Val: ";"},
    // Line 4
    &query_processor.Token{Token_type: "Keyword", Val: "insert_into"},
    ...
    &query_processor.Token{Token_type: "Keyword", Val: "values"},
    &query_processor.Token{Token_type: "Operator", Val: "("},
    &query_processor.Token{Token_type: "Literal", Val: "luna"},
    &query_processor.Token{Token_type: "Operator", Val: ","},
    &query_processor.Token{Token_type: "Literal", Val: "5"},
    &query_processor.Token{Token_type: "Operator", Val: ","},
    &query_processor.Token{Token_type: "Literal", Val: "5"},
    &query_processor.Token{Token_type: "Operator", Val: ")"},
    &query_processor.Token{Token_type: "Operator", Val: ","},
    // Line 6
    &query_processor.Token{Token_type: "Operator", Val: "("},
    &query_processor.Token{Token_type: "Literal", Val: "milo"},
    &query_processor.Token{Token_type: "Operator", Val: ","},
    &query_processor.Token{Token_type: "Literal", Val: "2"},
    &query_processor.Token{Token_type: "Operator", Val: ","},
    &query_processor.Token{Token_type: "Literal", Val: "3"},
    &query_processor.Token{Token_type: "Operator", Val: ")"},
    &query_processor.Token{Token_type: "Operator", Val: ";"},
    // Line 8
    &query_processor.Token{Token_type: "Keyword", Val: "select"},
    &query_processor.Token{Token_type: "Operator", Val: "*"},
    &query_processor.Token{Token_type: "Keyword", Val: "from"},
    &query_processor.Token{Token_type: "Identifier", Val: "cats"},
    &query_processor.Token{Token_type: "Operator", Val: ";"},
    // Line 10
    &query_processor.Token{Token_type: "Keyword", Val: "create"},
    &query_processor.Token{Token_type: "Keyword", Val: "table"},
    &query_processor.Token{Token_type: "Identifier", Val: "cats"},
    &query_processor.Token{Token_type: "Operator", Val: "("},
    // Line 11
    &query_processor.Token{Token_type: "Identifier", Val: "id"},
    &query_processor.Token{Token_type: "Keyword", Val: "integer"},
    &query_processor.Token{Token_type: "Keyword", Val: "primary_key"},
    &query_processor.Token{Token_type: "Operator", Val: ","},
    // Line 12
    &query_processor.Token{Token_type: "Identifier", Val: "cat_names"},
    &query_processor.Token{Token_type: "Keyword", Val: "text"},
    &query_processor.Token{Token_type: "Operator", Val: ","},
    // Line 13
    &query_processor.Token{Token_type: "Identifier", Val: "age"},
    &query_processor.Token{Token_type: "Keyword", Val: "integer"},
    ...
    // Line 14
    &query_processor.Token{Token_type: "Identifier", Val: "weight"},
    &query_processor.Token{Token_type: "Keyword", Val: "real"},
    // Line 15
    &query_processor.Token{Token_type: "Operator", Val: ")"},
    &query_processor.Token{Token_type: "Operator", Val: ";"},
}
